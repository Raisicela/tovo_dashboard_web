...
class TableDriversAproved extends React.Component {
    ...
    var data = {
      ...
      rows: this.props.usersRequest.map((appUser) => {
        return {
          ...
          gender: appUser.personalInformation.data.gender === 0
            ? "Hombre"
            : "Mujer",
          action: (
            <Link to={`${ROUTES.PROFILE}/${appUser.userId}/driver`}>
...
export default TableDriversAproved;
